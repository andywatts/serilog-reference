...
{
    private static readonly string logFileFolder = Application.dataPath + "/Logs"; // Application.persistentDataPath + "/Logs";
    private static readonly string seqServer = "http://localhost:5341";
    private static readonly string logFilePath = logFileFolder + "/client.log";
